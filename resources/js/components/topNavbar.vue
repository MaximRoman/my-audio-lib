<template>
  <ul  id="top-navbar" class="col-6 nav mr-auto d-flex align-items-center d-flex h-100">
    <li id="search-input-container" class="nav-item col-9 d-flex align-items-center justify-content-center invisible">
    ...
    <li id="search-icon-container" class="nav-item col-3 h-100 d-flex align-items-center justify-content-center ">
    ...
    <li id="fav" class="nav-item col-3 h-100 d-flex align-items-center justify-content-center">
    ...
    <li id="theme" class="nav-item col-3 h-100 d-flex align-items-center justify-content-center">
